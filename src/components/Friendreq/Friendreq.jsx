  ...
  return (
    ...
    <div className='shadow shadow-box rounded-[20px] pb-[21px]'>
        ...
        <img src={fone} alt=''></img>
          ...
          <button className='bg-primary rounded pl-[10px] pr-[10px] pt-[5px] pb-[5px] ml-[85px] font-pops text-[20px] font-semibold text-white'>Accept</button>
        </div>
        ...
        <img src={ftwo} alt=''></img>
          ...
          <button className='bg-primary rounded pl-[10px] pr-[10px] pt-[5px] pb-[5px] ml-[95px] font-pops text-[20px] font-semibold text-white'>Accept</button>
        </div>
        <div className='border-b w-[350px] mx-auto mt-[10px]'></div>
        ...
        <img src={fthree} alt=''></img>
          ...
          <button className='bg-primary rounded pl-[10px] pr-[10px] pt-[5px] pb-[5px] ml-[110px] font-pops text-[20px] font-semibold text-white'>Accept</button>
        </div>
        <div className='border-b w-[350px] mx-auto mt-[10px]'></div>
        ...
        <img src={ffour} alt=''></img>
          ...
          <button className='bg-primary rounded pl-[10px] pr-[10px] pt-[5px] pb-[5px] ml-[20px] font-pops text-[20px] font-semibold text-white'>Accept</button>
        </div>
    </div>
    </div>
  )
