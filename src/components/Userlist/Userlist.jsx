  ...
  return (
    ...
    <div className='shadow shadow-box rounded-[20px] pb-[21px] pt-[5px]'>
        ...
        <img src={fone} alt=''></img>
          ...
          <button className='bg-primary rounded pl-[10px] pr-[10px] pt-[5px] pb-[5px] ml-[165px] font-pops text-[20px] font-semibold text-white'>+</button>
        </div>
        ...
        <img src={ftwo} alt=''></img>
          ...
          <button className='bg-primary rounded pl-[10px] pr-[10px] pt-[5px] pb-[5px] ml-[175px] font-pops text-[20px] font-semibold text-white'>+</button>
        </div>
        <div className='border-b w-[350px] mx-auto mt-[10px]'></div>
        ...
        <img src={fthree} alt=''></img>
          ...
          <button className='bg-primary rounded pl-[10px] pr-[10px] pt-[5px] pb-[5px] ml-[188px] font-pops text-[20px] font-semibold text-white'>+</button>
        </div>
        <div className='border-b w-[350px] mx-auto mt-[10px]'></div>
        ...
        <img src={ffour} alt=''></img>
          ...
          <button className='bg-primary rounded pl-[10px] pr-[10px] pt-[5px] pb-[5px] ml-[95px] font-pops text-[20px] font-semibold text-white'>+</button>
        </div>
    </div>
    </div>
  )
